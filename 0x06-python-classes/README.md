...
# !/usr/bin/python3
Square = **import**('2-square').Square

my_square_1 = Square(3)
print(type(my_square_1))
print(my_square_1.**dict**)

my_square_2 = Square()
print(type(my_square_2))
print(my_square_2.**dict**)
