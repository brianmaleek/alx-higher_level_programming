...
- Your code should be `semistandard` compliant. [Rules of Standard](https://intranet.alxswe.com/rltoken/1T1yg1vOAChRN20Yyz8crw) + [semicolons](https://intranet.alxswe.com/rltoken/35q5Pc6A6KWPyd3kGeRQFg) on top. Also as reference: [AirBnB style](https://intranet.alxswe.com/rltoken/ilo9MmB3u0utJZjZat-W3Q)
...
- Your script must import `list` from the file `100-data.j`s
